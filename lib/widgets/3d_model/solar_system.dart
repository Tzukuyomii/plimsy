...
//     mercury.position.x =
//         25 * cos(0.005 * DateTime.now().millisecondsSinceEpoch);
//     mercury.position.z =
//         25 * sin(0.005 * DateTime.now().millisecondsSinceEpoch);

//     venus.position.x = 35 * cos(0.003 * DateTime.now().millisecondsSinceEpoch);
//     venus.position.z = 35 * sin(0.003 * DateTime.now().millisecondsSinceEpoch);

//     earth.position.x = 50 * cos(0.002 * DateTime.now().millisecondsSinceEpoch);
//     earth.position.z = 50 * sin(0.002 * DateTime.now().millisecondsSinceEpoch);

//     mars.position.x = 70 * cos(0.001 * DateTime.now().millisecondsSinceEpoch);
//     mars.position.z = 70 * sin(0.001 * DateTime.now().millisecondsSinceEpoch);

//     jupiter.position.x =
//         100 * cos(0.0005 * DateTime.now().millisecondsSinceEpoch);
//     jupiter.position.z =
//         100 * sin(0.0005 * DateTime.now().millisecondsSinceEpoch);

//     saturn.position.x =
//         130 * cos(0.0004 * DateTime.now().millisecondsSinceEpoch);
//     saturn.position.z =
//         130 * sin(0.0004 * DateTime.now().millisecondsSinceEpoch);

//     uranus.position.x =
//         160 * cos(0.0003 * DateTime.now().millisecondsSinceEpoch);
//     uranus.position.z =
//         160 * sin(0.0003 * DateTime.now().millisecondsSinceEpoch);

//     neptune.position.x =
//         190 * cos(0.0002 * DateTime.now().millisecondsSinceEpoch);
//     neptune.position.z =
//         190 * sin(0.0002 * DateTime.now().millisecondsSinceEpoch);
